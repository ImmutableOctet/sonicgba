	...
	Public
		...
		Public Method draw:Void(g:MFGraphics)
			...
			If (isDrawTouchPad) Then
				If (Not (Self.state = STATE_STAGE_LOADING Or Self.state = BIRD_SPACE_2)) Then
