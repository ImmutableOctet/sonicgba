...
Class ConstUtil
	Public
		...
		'''Global TRANS:Short[] = [0, FLIP_Y, FLIP_X, ROTATE_180, (ROTATE_180 - ROTATE_270), (ROTATE_180 | ROTATE_270), ROTATE_270, (FLIP_X|ROTATE_270)] ' Const
		Global TRANS:Short[] = [0, 16384, 8192, 24576, 20480, 28672, 4096, 12288]
