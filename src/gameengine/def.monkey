...
' Constant variable(s):
Global SCREEN_WIDTH:Int = GBA_EXT_WIDTH ' MDPhone.SCREEN_WIDTH ' MyAPI.zoomIn(MDPhone.SCREEN_WIDTH, True) ' 284 ' MyAPI.zoomIn(MFDevice.getScreenWidth(), True) ' Const
Global SCREEN_HEIGHT:Int = GBA_HEIGHT ' MDPhone.SCREEN_HEIGHT ' MyAPI.zoomIn(MDPhone.SCREEN_HEIGHT, True) ' 160 ' MyAPI.zoomIn(MFDevice.getScreenHeight(), True) ' Const
